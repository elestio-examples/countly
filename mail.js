...
function getPluginConfig() {
  ...
  if (plugins.indexOf("white-labeling") > -1) {
    try {
      ...
      _company =
        emailCompany && emailCompany.length > 0 ? emailCompany : company;
    } catch (error) {
...
module.exports = function (mail) {
    ...
    mail.lookup(function (err, host) {
      mail.sendMessage(
        ...
        "Hi " +
          ...
          "'>" +
          host +
          "</a> is created with the following details;<br/><br/>\n" +
          "Username: " +
          member.username +
          "<br/>Password: " +
          password +
  ...
  mail.sendToUpdatedMember = function (member, memberPassword) {
    ...
    mail.lookup(function (err, host) {
      mail.sendMessage(
        member.email,
        "" + company + " Account - Password Change",
        "Hi " +
          mail.getUserFirstName(member) +
          ",<br/><br/>\n" +
          ...
          "'>" +
          host +
          "</a> has been changed. Below you can find your updated account details;<br/><br/>\n" +
          "Username: " +
          member.username +
          "<br/>Password: " +
          password +
    ...
    mail.lookup(function (err, host) {
      mail.sendMessage(
        ...
        "Hi " +
          ...
          "You can reset your " +
          company +
          " account password by following <a href='" +
          host +
          "/reset/" +
          prid +
          "'>this link</a>.<br/><br/>\n" +
  ...
  mail.sendAutomatedMessageError = function (member, link) {
    ...
    mail.lookup(function (err, host) {
      ...
      mail.sendMessage(
        member.email,
        company + " Automated Push Problem",
        "Hi " +
          mail.getUserFirstName(member) +
          ",,<br/><br/>\n" +
          'Your <a href="' +
          link +
          '">automated message</a> cannot be sent due to a repeating error.\n' +
